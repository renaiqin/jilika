<template>
  <div class="selectwarp">
    ...
    <!-- 发卡记录不为空时 -->
    <div class="cardwarp"  ref="scrollBox">
        <div class="cardItem" v-for="(item,index) in cardlist" >
            <div class="groupwarp" :class="{'on_del':item.isOnDel}">
                <img :src="'http://115.231.105.146/'+(item.tplj?item.tplj:'/static/img/test1.png')"  class="groupleft"/>
                <div class="groupmid" >
                </div>
                <div class="groupright">
                <p>获卡人：{{selfObj.name}}</p>
                <p>评价人：{{item.ckrxm}}</p>
                <p>日期：{{item.bfsj}}</p>
                </div>
    ...
    <transition name="layer">
        <div class="cardDetail" v-if="showpopup">
            ...
            <img class="cardimg" :src="'http://115.231.105.146/' + (cardDetailData.tplj?cardDetailData.tplj:'/static/img/test1.png')" />
            <p class="detailP">
            <span>获卡学生</span>
            ...
            <div class="imgarr" v-if="cardDetailData.fjList.length>0">
            <img v-for="(item,index) in cardDetailData.fjList" :key="index" :src="item.sclj.indexOf('http') > -1 ? item.sclj : 'http://115.231.105.146/'+item.sclj" />
  ...
  export default {
    ...
    methods: {
        ...
        async init(){
            ...
            console.log('加载啦');
            console.log(this.$route.query.kplx,126);
            //获得周次列表
        ...
        */
        ...
        async queryPageList(){
            ...
            //await 
                ...
                // }
                var res = await this.$fetch(api.getCardInfo(),{xxdm: localStorage.getItem('xxdm'),xqdm:localStorage.getItem('xq'),xndm:localStorage.getItem('xn'),xh:localStorage.getItem("xh"),kplx:this.$route.query.kplx});
         ...
         */
        renderPostcard(){
        this.$router.push({path:'/pages/student/cardsList/postCard'})
        },
